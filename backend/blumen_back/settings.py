"""
Django settings for blumen_back project.
...
SECRET_KEY = 'django-insecure-dp3sx-8rqphm63jf-7z(db266wd+f%$kc4_!et6wdjal(m79@&'
...
WSGI_APPLICATION = 'blumen_back.wsgi.application'
